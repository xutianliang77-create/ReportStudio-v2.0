...
from reportstudio.core.metrics.compute import plan_metric_compute_order
...
def plan_metrics_order(metric_expressions: dict[str, str]) -> list[str]:
    """P2-102 bridge: expose DAG planning without affecting P1 metric outputs."""

    return plan_metric_compute_order(metric_expressions, fallback_to_dsl_basic=True)
